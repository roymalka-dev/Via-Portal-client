...
export const generatePartnerScoringTableData = (): TableData => {
  return {
    ...
    rows: [
      [
        `Commercial sensitivity / temperature ${
          scopingBadges.ps + " " + scopingBadges.mandatory
        }`,
        `${
          scopingIcons.greenCircle +
          " / " +
          scopingIcons.yellowCircle +
          " / " +
          scopingIcons.redCircle
        }`,
      ],
      [
        `Partner tech savviness ${
          scopingBadges.ps + " " + scopingBadges.mandatory
        }`,
        `${
          scopingIcons.greenCircle +
